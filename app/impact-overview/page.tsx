...
const impactCards = [
  { icon: Soup, title: 'More Meals Reached', text: 'Surplus food gets redirected to kitchens, shelters, and families in need.' },
  { icon: Leaf, title: 'Less Food Waste', text: 'Usable food is rescued before disposal, reducing pressure on landfills.' },
  { icon: Waves, title: 'Lower Emissions', text: 'Recovered food contributes to lower waste-related greenhouse impact.' },
    ...
    <div className="min-h-screen bg-[#f4f7f2] px-4 py-6 md:px-8 md:py-8">
      <main className="mx-auto max-w-6xl rounded-2xl border border-[#e4e9e1] bg-white p-5 shadow-[0_1px_2px_rgba(13,30,14,0.06)] md:p-7">
        ...
        <section className="px-2 pb-4 pt-10 md:px-3">
          <h1 className="text-4xl font-extrabold leading-tight text-[#141b17] md:text-5xl">Why the Impact Matters</h1>
          <p className="mt-3 max-w-3xl text-base leading-relaxed text-[#5f6d63] md:text-lg">
            MealSaver exists to make food donation practical at scale. Every rescued meal supports both social welfare and
