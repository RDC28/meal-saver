...
const benefits = [
  { icon: Timer, title: 'Fast Pickup Coordination', text: 'List food quickly and connect with verified NGOs nearby.' },
  { icon: ShieldCheck, title: 'Safer Distribution', text: 'Structured pickup flow helps reduce misuse and delays.' },
  { icon: TrendingUp, title: 'Measurable ESG Impact', text: 'Track meals served and food waste reduced with visibility.' },
  { icon: CheckCircle2, title: 'Compliance-Friendly Logs', text: 'Maintain digital records of donation activities.' },
]
    ...
    <div className="min-h-screen bg-[#f4f7f2] px-4 py-6 md:px-8 md:py-8">
      <main className="mx-auto max-w-6xl rounded-2xl border border-[#e4e9e1] bg-white p-5 shadow-[0_1px_2px_rgba(13,30,14,0.06)] md:p-7">
        ...
        <section className="px-2 pb-4 pt-10 md:px-3">
          <h1 className="text-4xl font-extrabold leading-tight text-[#141b17] md:text-5xl">For Donors</h1>
          <p className="mt-3 max-w-3xl text-base leading-relaxed text-[#5f6d63] md:text-lg">
            Restaurants, bakeries, caterers, stores, and individuals can convert surplus food into meaningful community support.
            MealSaver makes donation logistics simple and trackable.
          </p>
        </section>
